...
// uint8_t read_fifo_burst_SD(ArduCAM myCAM)
// {
//     uint8_t temp = 0, temp_last = 0;
//   uint32_t length = 0;
//   length = myCAM.read_fifo_length();
...
//   // Create a file on the SD card with a unique name based on the current time
//   char filename[20];
...
//     if (is_header == true)
//     {
//       // Write the image data to the SD card file
//       file.write(temp);
//     }
//     else if ((temp == 0xD8) & (temp_last == 0xFF))
//     {
...
//     if ( (temp == 0xD9) && (temp_last == 0xFF) ) //If find the end ,break while,
//     {
//       // Close the SD card file and return success
//       file.close();
//       myCAM.CS_HIGH();
//       is_header = false;
//       return 1;
